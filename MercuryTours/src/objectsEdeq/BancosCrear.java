...
public class BancosCrear extends PageBase{
	 ...
	 * @param nombreBanco nombre del banco que le va a ingresar
	...
	public void crearBancos(String nombreBanco) throws InterruptedException {
		...
		esperar(5);//Espera 5 segundos para dar tiempo a la pantalla
	 ...
	 * @param nombreBanco nombre del banco, deberia contener numeros
	 * @throws InterruptedException
	 */
