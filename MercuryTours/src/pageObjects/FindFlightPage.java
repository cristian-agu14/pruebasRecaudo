...
public class FindFlightPage extends PageBase {
	...
	@FindBy(how= How.XPATH, using ="//html/body/form/div/div/div[2]/div[2]/div[1]/input")
	private WebElement cajaTextoUsser;
	
	@FindBy(how = How.XPATH, using="//html/body/form/div/div/div[2]/div[2]/div[2]/input" )
	private WebElement cajaTextoPasswork;

	public WebElement getCajaTextoUsser() {
		return cajaTextoUsser;
	}

	public void setCajaTextoUsser(WebElement cajaTextoUsser) {
		this.cajaTextoUsser = cajaTextoUsser;
	}

	public WebElement getCajaTextoPasswork() {
		return cajaTextoPasswork;
	}

	public void setCajaTextoPasswork(WebElement cajaTextoPasswork) {
		this.cajaTextoPasswork = cajaTextoPasswork;
	}
